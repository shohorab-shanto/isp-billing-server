...
class Rbac
{
    ...
    private static function seedPermissions()
    {
        $permissions = [
            ...
            'settings.general' => ['General Settings', 'Settings', 'submenu'],
            'settings.localisation' => ['Localisation', 'Settings', 'submenu'],
            'settings.custom_fields' => ['Custom Fields', 'Settings', 'submenu'],
            'settings.miscellaneous' => ['Miscellaneous', 'Settings', 'submenu'],
            'settings.maintenance' => ['Maintenance Mode', 'Settings', 'submenu'],
            'settings.widgets' => ['Widgets', 'Settings', 'submenu'],
            'settings.notifications' => ['User Notification', 'Settings', 'submenu'],
            'settings.devices' => ['Devices', 'Settings', 'submenu'],
            ...
            'settings.backup_db' => ['Backup/Restore DB', 'Settings', 'plugin'],
            'settings.clear_cache' => ['Clear System Cache', 'Settings', 'plugin'],
            'settings.mikrotik_import' => ['Mikrotik Import', 'Settings', 'plugin'],
            'settings.payment_page' => ['Payment Page Settings', 'Settings', 'plugin'],
            'settings.system_info' => ['System Info', 'Settings', 'plugin'],
            'settings.alt_wa_gateway' => ['Alt WA Gateway', 'Settings', 'plugin'],
            ...
            'radius.online_users' => ['Radius Online Users', 'Radius', 'plugin'],
            'radius.rest_online_users' => ['Users Online', 'Radius', 'plugin'],
            'radius.nas_status' => ['Radius NAS Status', 'Radius', 'plugin'],
    ...
    {
        $seedVersion = '20260517-all-menu-submenu-permissions-v2';
        ...
        $rolePermissions = [
            ...
            'admin' => [
                ...
                'settings.general', 'settings.localisation', 'settings.custom_fields', 'settings.miscellaneous',
                'settings.maintenance', 'settings.widgets', 'settings.notifications', 'settings.devices',
                'settings.users', 'settings.backup', 'settings.payment_gateway', 'settings.backup_db',
                'settings.clear_cache', 'settings.mikrotik_import', 'settings.payment_page',
                'settings.system_info', 'settings.alt_wa_gateway', 'settings.plugin_manager',
                ...
                'radius.online_users', 'radius.rest_online_users', 'radius.nas_status',
